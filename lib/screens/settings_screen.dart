...
import '../dialogs/hide_profile_dialog.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  String _showMeOption2() {
    // Variables
    final Map<String, dynamic> settings = UserModel().user.userSettings!;
    final String? showMe = settings[USER_Hide_Time];
    // Check option
    if (showMe != null) {
      return showMe;
    }
              ...
              children: [
                ...
                Card(
                  child: ListTile(
                    ...
                    title: const Text("show/hide profile",
                        style: TextStyle(fontSize: 18)),
                    trailing:  Text(_showMeOption2(),
                        style: const TextStyle(fontSize: 18)),
                    onTap: () {
                      /// Choose Show me option
                      showDialog(
                          ...
                          barrierDismissible: false,
                          builder: (context) {
                            return const HideProfileDialog();
                          });
                    },
                  ),
                ),
