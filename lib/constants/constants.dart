...
///
const String APP_NAME = "Insta Matching";
const Color APP_PRIMARY_COLOR = Color(0xffc5014b);
const Color APP_ACCENT_COLOR = Color(0xfffe964d);
...
const String USER_Hide_Profile_Time = "user_hide_profile_time";
const String USER_Hide_Time = "user_hide_time";
